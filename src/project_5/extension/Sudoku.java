...
public class Sudoku {
     ...
     *             Must be a perfect square for the rules of Sudoku to still apply.
     */
    public Sudoku(int numFilled, int size) throws Exception {
        board = new Board(numFilled, size);
    ...
    public int findNextValue(Cell cell) {
        for (int value = cell.getValue() + 1; value <= board.getSize(); value++)
    ...
    public boolean solve(int delay) throws Exception {
        ...
        int numUnspecifiedCells = (board.getSize() * board.getSize()) - board.numLocked();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Sudoku sudoku2 = new Sudoku(10, 9);
