...
public class SocialAgent extends Agent {
    ...
    /**
     * Returns a copy of the current social agent.
     *
     * @return An SocialAgent object with the exact same field values as the current agent.
     */
    public SocialAgent clone(){
        SocialAgent copy = new SocialAgent(getX(), getY(), getRadius());
