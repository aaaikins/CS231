...
public class Landscape {
    ...
    public int updateAgents() {
        ...
        // create a copy of the landscape from the previous update
        Landscape copyLandscape = new Landscape(width, height);

        for (Agent agent: landscape) {
            copyLandscape.landscape.add(agent.clone());
        }

        // update state of each agent based on copy landscape
        for (Agent agent : landscape) {
            agent.updateState(copyLandscape);
